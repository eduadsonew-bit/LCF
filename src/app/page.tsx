      ...
      <div className="overflow-hidden py-2">
        <div ref={scrollRef} className="flex will-change-transform">
          {[...sponsors, ...sponsors, ...sponsors, ...sponsors].map((sponsor, index) => (
            ...
            >
              {sponsor.logo ? (
                <div className="w-28 h-28 md:w-36 md:h-36 rounded-full bg-red-700 flex items-center justify-center shadow-xl overflow-hidden border border-red-800/60 relative before:absolute before:inset-0 before:bg-gradient-to-br before:from-white/20 before:via-transparent before:to-transparent before:rounded-full before:pointer-events-none after:absolute after:inset-0 after:bg-gradient-to-tl after:from-transparent after:via-transparent after:to-black/20 after:rounded-full after:pointer-events-none">
                  <img
                    src={sponsor.logo}
                    alt={sponsor.name}
                ...
                <div className="w-28 h-28 md:w-36 md:h-36 rounded-full bg-red-700 flex items-center justify-center shadow-xl border border-red-800/60 relative before:absolute before:inset-0 before:bg-gradient-to-br before:from-white/20 before:via-transparent before:to-transparent before:rounded-full before:pointer-events-none after:absolute after:inset-0 after:bg-gradient-to-tl after:from-transparent after:via-transparent after:to-black/20 after:rounded-full after:pointer-events-none">
                  <span className="text-white font-bold text-xs md:text-sm text-center px-1 relative z-10">
                    {sponsor.name}
                  </span>
                </div>
              )}
